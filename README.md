...
5. Выложить [историю команд](ССЫЛКА НА ИСТОРИЮ КОМАНД) в терминале ubuntu
6. Нарисовать [диаграмму](ССЫЛКА НА ДИАГРАММУ), в которой есть класс родительский класс, домашние
